package eu.telecom_bretagne.ambSocialNetwork.front.utils;
...
public class ServicesLocator
{
	...
	public Object getRemoteInterface(String nomEJB) throws ServicesLocatorException
	{
		...
		else if(nomEJB.equals("UtilisateurDAO"))
			nomJNDI = "java:global/AMBSocialNetworkServer/AMBSocialNetworkServerEJB/UtilisateurDAO!eu.telecom_bretagne.ambSocialNetwork.data.dao.UtilisateurDAO";
